<template>
  <div class="knowledge-panel">
    ...
    <div class="file-list-header">
      ...
      <el-button text size="small" @click="loadFiles" :loading="loading">
...
function handleFileChange(file) {
  ...
  if (file.size > MAX_SIZE) {
    ElMessage.warning(`文件过大: ${file.name}（限制 15MB）`)
    return
  }
